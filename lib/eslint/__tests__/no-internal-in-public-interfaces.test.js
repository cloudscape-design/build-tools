  ...
  test("valid", () =>
    runRule({
      valid: [
        ...
        // The same allowed sources, naming the emitted file.
        { code: "import { BarProps } from '../bar/interfaces.js';\nexport interface FooProps extends BarProps {}", filename: PUBLIC },
        { code: "import { BaseComponentProps } from '../types/base-component.js';\nexport interface FooProps extends BaseComponentProps {}", filename: PUBLIC },
        { code: "export { BarProps } from '../bar/interfaces.js';", filename: PUBLIC },
        { code: "export * from '../bar/interfaces.mjs';", filename: PUBLIC },
  ...
  test("invalid", () =>
    runRule({
      invalid: [
        ...
        // Still disallowed with an emitted extension: it ends in `-interfaces.js`, not `/interfaces.js`.
        {
          code: "import { ItemProps } from './internal-interfaces.js';\nexport interface FooProps { item: ItemProps; }",
          filename: PUBLIC,
          errors: [{ messageId: "disallowedImport", data: { source: "./internal-interfaces.js" } }],
        },
        {
          code: "import { SomeRequired } from '../internal/types.js';\nexport type X = SomeRequired;",
          filename: PUBLIC,
          errors: [{ messageId: "disallowedImport", data: { source: "../internal/types.js" } }],
        },
        {
          code: "import { BaseCheckboxProps } from '../checkbox/base-checkbox.js';\nexport interface FooProps extends BaseCheckboxProps {}",
          filename: PUBLIC,
          errors: [{ messageId: "disallowedImport", data: { source: "../checkbox/base-checkbox.js" } }],
        },
        {
