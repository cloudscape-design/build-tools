...
// The consuming repositories load these rules as a flat-config plugin on ESLint 9. This covers the
// flat-config path and the plugin barrel, so a rule that is unreachable or misnamed there fails here.
